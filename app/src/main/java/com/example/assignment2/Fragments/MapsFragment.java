...
public class MapsFragment extends Fragment
{
    ...
    public MapsFragment setScoreLatitude(double scoreLatitude)
    {
        this.scoreLatitude = scoreLatitude;
        return this;
    }

    public MapsFragment setScoreLongitude(double scoreLongitude)
    {
        this.scoreLongitude = scoreLongitude;
        return this;
    }
